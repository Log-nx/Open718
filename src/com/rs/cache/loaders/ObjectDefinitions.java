...
public class ObjectDefinitions {
	...
	public static void main(String[] args) throws IOException {
		Cache.init();
		ObjectDefinitions defs = getObjectDefinitions(7771);
		/*
		...
		System.out.println("VarId: " + defs.configFileId + ", vaarbitId" + defs.configId);
		...
		System.out.println(defs.parameters);
	}
	...
	public static ObjectDefinitions getObjectDefinitions(int id) {
		...
		if (def == null) {
			...
			def.id = id;
			byte[] data = Cache.RS3CACHE.getIndexes()[16].getFile(getArchiveId(id), id & 0xff);
			if (data == null) {
