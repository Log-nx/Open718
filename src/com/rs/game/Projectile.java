...
public class Projectile {
	...
	public WorldTile from;
	public WorldTile to;
	public boolean adjustFlyingHeight, adjustSenderHeight;
	public int senderBodyPartId, graphicId, startHeight, endHeight, startTime,
			endTime, slope, angle;

	public Projectile(WorldTile from, WorldTile to, boolean adjustFlyingHeight,
