	...
	public static void loadWall(ClanWars c) {
		...
		case CLASSIC_AREA: // TODO: Real classic area.
			...
			for (int x = 5; x < 54; x++) {
				...
				WorldObject object = new WorldObject(28174 + objectOffset, 10,
						0, base.getX() + x, base.getY() + 64, 0);
		...
		case PLATEAU:
			for (int x = 32; x < 84; x++) {
				WorldObject object = new WorldObject(38687, 10, 0, base.getX()
						+ x, base.getY() + 32, 0);
				World.spawnObject(object);
				objects.add(object);
			}
		...
		case FORSAKEN_QUARRY:
			for (int x = 5; x < 25; x++) {
				WorldObject object = new WorldObject(38685, 10, 0, base.getX()
						+ x, base.getY() + 33, 0);
				World.spawnObject(object);
				objects.add(object);
			}
