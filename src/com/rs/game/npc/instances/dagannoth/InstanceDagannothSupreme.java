package com.rs.game.npc.instances.dagannoth;
...
public class InstanceDagannothSupreme extends NPC {
	
	int NPC = 2881;

	public InstanceDagannothSupreme(int id, WorldTile tile) {
				...
				if (loop == 0) {
					...
					if (player != null) {
						if (player.getTimer() != 0 || player.getTimer() > 0 && id == NPC) {			
							new InstanceDagannothSupreme(NPC, tile);
							}
						}
