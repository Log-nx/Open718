package com.rs.game.npc.instances.godwars.armadyl;
...
public class InstanceFlockleaderGeerin extends NPC {
	
	int NPC = 6225;

	public InstanceFlockleaderGeerin(int id, WorldTile tile) {
				...
				if (loop == 0) {
					...
					if (player != null) {
						if (player.getTimer() != 0 || player.getTimer() > 0 && id == NPC) {			
							new InstanceFlockleaderGeerin(NPC, tile);
							}
						}
