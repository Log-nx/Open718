package com.rs.game.npc.instances.godwars.zamorak;
...
public class InstanceKreeyath extends NPC {
	
	int NPC = 6208;

	public InstanceKreeyath(int id, WorldTile tile) {
