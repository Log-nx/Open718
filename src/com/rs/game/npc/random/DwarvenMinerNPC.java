...
public class DwarvenMinerNPC extends NPC {
    ...
    public void giveReward(final Player player) {
    	...
    	if (player.getStatistics().getBarsSmelt() >= 1000) {
			if (!player.getInventory().contains(25195))
				player.getInventory().addItem(25195, 1);
		}
    	if (player.getStatistics().getBarsSmelt() >= 2000) {
			if (!player.getInventory().contains(25196))
				player.getInventory().addItem(25196, 1);
		}
    	if (player.getStatistics().getBarsSmelt() >= 3000) {
			if (!player.getInventory().contains(25197))
				player.getInventory().addItem(25197, 1);
		}
    	if (player.getStatistics().getBarsSmelt() >= 4000) {
			if (!player.getInventory().contains(25198))
				player.getInventory().addItem(25198, 1);
		}
    	if (player.getStatistics().getBarsSmelt() >= 5000) {
			if (!player.getInventory().contains(25199))
		...
		player.sm("<col=ff0000>The Dwarven Miner gives you a reward before leaving.");
		player.lock(3);
