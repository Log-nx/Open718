...
public class LiquidGoldNymph extends NPC {
    ...
    public void giveReward(final Player player) {
    	...
    	if (player.getStatistics().getOresMined() >= 1000) {
			if (!player.getInventory().contains(20789))
				player.getInventory().addItem(20789, 1);
		}
		if (player.getStatistics().getOresMined() >= 2000) {
			if (!player.getInventory().contains(20791))
				player.getInventory().addItem(20791, 1);
		}
		if (player.getStatistics().getOresMined() >= 3000) {
			if (!player.getInventory().contains(20790))
				player.getInventory().addItem(20790, 1);
		}
		if (player.getStatistics().getOresMined() >= 4000) {
			if (!player.getInventory().contains(20788))
				player.getInventory().addItem(20788, 1);
		}
		if (player.getStatistics().getOresMined() >= 5000) {
			if (!player.getInventory().contains(20787))
		...
		player.getPackets().sendGameMessage("<col=ff0000>The Liquid Gold Nymph gives you a reward before leaving.");
		player.lock(3);
