...
public class HouseConstants {
	...
	public static enum Builds {
		...
		,
		RUG_3(new int[] { 15379, 15378, 15377 }, false, HObject.BROWN_RUG, HObject.RUG, HObject.OPULENT_RUG)
		// BED ROOM
		,
		...
		RUG_BEDROOM(new int[] { 15266, 15265, 15264 }, false, HObject.BROWN_RUG, HObject.RUG, HObject.OPULENT_RUG)
		// KITCHEN
		,
		...
		RUG_2(new int[] { 15389, 15388, 15387 }, false, HObject.BROWN_RUG, HObject.RUG, HObject.OPULENT_RUG)
		...
		RUG_4(new int[] { 15274, 15273 }, false, HObject.BROWN_RUG, HObject.RUG, HObject.OPULENT_RUG),
		...
		CAGE(new int[] { 15352, 15353 }, false, HObject.OAK_CAGE, HObject.OAK_AND_STEEL_CAGE, HObject.FULL_STEEL_CAGE, HObject.SPIKED_CAGE, HObject.BONE_CAGE),
		FLOOR_SPACE(new int[] { 15347, 15348, 15349, 15350, 15351 }, false, HObject.SPIKES, HObject.TENTACLE_POOL, HObject.FLAME_PIT, HObject.ROCNAR),
		...
		HABITAT(new int[] { 44843, 44844, 44845, 44846, 44847, 44848, 44849, 44850, 44851, 44852, 44853, 44854, 44855, 44856, 44857, 44858, 44859, 44860, 44861, 44862, 44863, 44864, 44865, 44866, 44867, 44868, 44869, 44870, 44871, 44872, 44873, 44874, 44875, 44876, 44877, 44878, 44879, 44880, 44881, 44882, 44883, 44884, 44885, 44886, 44887, 44888, 44889, 44890, 44891, 44892, 44893, 44894, 44895, 44896, 44897, 44898, 44899, 44900, 44901, 44902, 44903, 44904, 44905, 44906, 44907, 44908 }, true, HObject.GARDEN_HABITAT, HObject.JUNGLE_HABITAT, HObject.DESERT_HABITAT, HObject.POLAR_HABITAT, HObject.VOLCANIC_HABITAT)

		,
		DUNGEON_DOOR1(new int[] { 15328, 15329 }, false, HObject.OAK_DOOR, HObject.STEEL_PLATED_DOOR, HObject.MARBLE_DOOR),
		DUNGEON_DOOR2(new int[] { 15326, 15327 }, false, HObject.OAK_DOOR, HObject.STEEL_PLATED_DOOR, HObject.MARBLE_DOOR)
	...
	public static enum HObject {
		...
		FULL_STEEL_CAGE(8299, new int[] { 13319, 13320 }, 75, 400, new Item(STEEL_BAR, 20)),
		...
		// FLOOR_SPACE
		,
		SPIKES(8302, new int[] { 13334, 13335, 13336, 13334, 13334 }, 65, 623, new Item(STEEL_BAR, 20), new Item(995, 50000)),
		TENTACLE_POOL(8303, new int[] { 13331, 13332, 13333, 13331, 13331 }, 71, 326, new Item(1929, 20), new Item(995, 100000)),
		FLAME_PIT(8304, new int[] { 13337, 13337, 13337, 13337, 13337 }, 77, 357, new Item(590, 20), new Item(995, 125000)),
		ROCNAR(8305, new int[] { 13338, 13339, 13340, 13338, 13338 }, 83, 387, new Item(995, 150000))
	...
	public static enum POHLocation {
		...
		EDGEVILLE(new WorldTile(3101, 3492, 0), 1, 2500),
	...
	public static final WorldTile[] PORTAL_COORDINATES = { new WorldTile(3212, 3424, 0), new WorldTile(3222, 3218, 0), new WorldTile(2964, 3379, 0), new WorldTile(2757, 3478, 0), new WorldTile(2664, 3305, 0), new WorldTile(2547, 3113, 2), new WorldTile(3492, 3471, 0) };

	public static final int[] DUNGEON_DOOR_LEVELS = { 35, 66, 80 };
	public static Room[] DUNGEON_ROOMS = { Room.TREASURE_ROOM, Room.OUTBLIETTE, Room.DUNGEON_CORRIDOR, Room.DUNGEON_JUNCTION, Room.DUNGEON_PIT, Room.DUNGEON_STAIRS };
