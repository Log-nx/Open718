...
public class Slayer {
	...
	public enum SlayerMaster implements Serializable {
		...
		TURAEL(8480, 3, 1, new int[] { 0, 0, 0 }, new int[] { 15, 50 },
				...
				SlayerTask.MINOTAUR, SlayerTask.MONKEY, SlayerTask.SCORPION,
				SlayerTask.SKELETON, SlayerTask.SPIDER, SlayerTask.WOLF,
				SlayerTask.ZOMBIE),

		MAZCHNA(8481, 20, 1, new int[] { 2, 5, 15 }, new int[] { 20, 60 },
				...
				SlayerTask.SKELETON, SlayerTask.VAMPYRE, SlayerTask.WOLF,
				SlayerTask.ZOMBIE),

		ACHTRYN(8465, 20, 1, new int[] { 2, 5, 15 }, new int[] { 20, 60 },
				SlayerTask.BANSHEE, SlayerTask.BAT, SlayerTask.CATABLEPON,
				SlayerTask.CAVE_CRAWLER, SlayerTask.COCKATRICE,
				SlayerTask.CRAWLING_HAND, SlayerTask.CYCLOPS,
				SlayerTask.DESERT_LIZARD, SlayerTask.DOG,
		...
		VANNAKA(1597, 40, 1, new int[] { 4, 20, 60 }, new int[] { 30, 70 },
		...
		CHAELDAR(1598, 70, 1, new int[] { 10, 50, 100 }, new int[] { 40, 80 },
				SlayerTask.ABERRANT_SPECTRE, SlayerTask.BANSHEE,
				SlayerTask.BASILISK, SlayerTask.BLOODVELD,
		...
		SUMONA(7780, 85, 35, new int[] { 12, 60, 180 }, new int[] { 50, 100 },
				...
				SlayerTask.NECHRYAEL, SlayerTask.RED_DRAGON,
				SlayerTask.SCABARITE, SlayerTask.SPIRITUAL_MAGE,
				SlayerTask.SPIRITUAL_WARRIOR, SlayerTask.TERROR_DOG,
				SlayerTask.TROLL, SlayerTask.TUROTH, SlayerTask.VYREWATCH),

		DURADEL(8466, 100, 50, new int[] { 15, 75, 225 },
				new int[] { 50, 100 }, SlayerTask.ABERRANT_SPECTRE,
				...
				SlayerTask.JADINKO, SlayerTask.NECHRYAEL, SlayerTask.SCABARITE,
				SlayerTask.SKELETAL_WYVERN, SlayerTask.SPIRITUAL_MAGE,
				SlayerTask.STEEL_DRAGON, SlayerTask.SUQAH,
				SlayerTask.VYREWATCH, SlayerTask.WARPED_TERRORBIRD,
		...
		KURADAL(9085, 110, 75, new int[] { 18, 90, 270 },
				new int[] { 25, 100 }, SlayerTask.ABERRANT_SPECTRE,
				...
				SlayerTask.NECHRYAEL, SlayerTask.SKELETAL_WYVERN,
				SlayerTask.SPIRITUAL_MAGE, SlayerTask.STEEL_DRAGON,
				SlayerTask.SUQAH, SlayerTask.TERROR_DOG, SlayerTask.TZHAAR,
				SlayerTask.TZHAAR, SlayerTask.VYREWATCH, SlayerTask.AIRUT, 
				SlayerTask.WARPED_TORTOISE, SlayerTask.WATERFIEND, SlayerTask.AIRUT),
		
		MORVRAN(20112, 120, 85, new int[] { 20, 100, 300 },
				new int[] { 25, 100 }, 
				SlayerTask.ABYSSAL_DEMON, SlayerTask.AVIANSIE,
				SlayerTask.AQUANITES, SlayerTask.BLACK_DEMON,
				SlayerTask.BLACK_DRAGON, SlayerTask.CELESTIAL_DRAGON, SlayerTask.DAGANNOTH,
				SlayerTask.DARK_BEAST, SlayerTask.DESERT_STRYKEWYRM, SlayerTask.EDIMMU,
				SlayerTask.ELVES, SlayerTask.GLACOR, SlayerTask.GREATER_DEMON, 
				SlayerTask.GANODERMIC, SlayerTask.GARGOYLE,
				SlayerTask.GRIFOLAPINE, SlayerTask.GRIFOLAROO,
				SlayerTask.GROTWORM, SlayerTask.ICE_STRYKEWYRM,
				SlayerTask.IRON_DRAGON, SlayerTask.JUNGLE_STRYKEWYRM,
				SlayerTask.KALPHITE, SlayerTask.LAVA_STRYKEWYRM,
				SlayerTask.MITHRIL_DRAGON, SlayerTask.JADINKO,
				SlayerTask.NECHRYAEL, SlayerTask.STEEL_DRAGON,
				SlayerTask.TORMENTED_DEMON, SlayerTask.SKELETAL_WYVERN, 
				SlayerTask.TZHAAR, SlayerTask.VYREWATCH,
				SlayerTask.WARPED_TORTOISE, SlayerTask.WATERFIEND, SlayerTask.AIRUT);

		private final SlayerTask[] task;
		private final int[] tasksRange;
		private final int[] pointsRange;
		private final int requiredCombatLevel;
		private final int requiredSlayerLevel;
		private final int npcId;

		SlayerMaster(int npcId, int requiredCombatLevel,
		...
		public static SlayerMaster getSlayerMasterForLevels(Player player) {
			SlayerMaster bestMaster = null;
			for (SlayerMaster master : SlayerMaster.values()) {
				if (player.getSkills().getCombatLevelWithSummoning() < master.getRequiredCombatLevel())
					continue;
				if (player.getSkills().getLevel(Skills.SLAYER) < master.getRequiredSlayerLevel())
					continue;
	...
	public enum SlayerTask implements Serializable {// 79 matches out of 117
		...
		MIGHTY_BANSHEE(37, new String[] {
				...
				"Mighty Banshees are found in Pollnivneach Slayer Dungeon." }),
		...
		MIGHTY_BANSEE(37, new String[] {
				...
				" You need something to cover your ears",
				"Beware of their scream.",
				"Mighty Banshees are found in Pollnivneach Slayer Dungeon." }, MIGHTY_BANSHEE),
		...
		BIRD(1,	new String[] {
						...
						"It's recommended that you bring range weapons to fight these monsters.",
		...
		VYRELORD(31, new String[] {}), VYRELADY(31, new String[] {}), VYREWATCH(
				31, new String[] {}, VYRELORD, VYRELADY),
		...
		LOCUST(1, new String[] {}), SCABARAS(1, new String[] {}), SCARAB(1,
				new String[] {}), SCABARITE(1, new String[] {}, LOCUST,
				SCABARAS, SCARAB),
		...
		DRAGONSTONE_DRAGON(95, new String[] {}),
		
		ONYX_DRAGON(98, new String[] {}),
		
		HYDRIX_DRAGON(101, new String[] {}),
		
		GEMSTONE_DRAGONS(81, new String[] {}, DRAGONSTONE_DRAGON, ONYX_DRAGON, HYDRIX_DRAGON),
		
		RUNE_DRAGON(1, new String[] {}),
		
		// finished
		TZHAAR(1, new String[] {});

		private final String[] tips;
		private final SlayerTask[] alternatives;
		private final int levelRequried;

		SlayerTask(int levelRequried, String[] tips,
	...
	private static int getLevelRequirement(String name) {
	...
	public static boolean hasEarmuffs(Entity target) {
		...
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == 4166 || hat == 13277 || hasSlayerHelmet(target) || hasMaskOfMourning(target);
	}
	
	public static boolean hasMaskOfMourning(Entity target) {
		if (!(target instanceof Player))
			return true;
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == ItemIdentifiers.MASK_OF_MOURNING || hat == ItemIdentifiers.HELM_OF_KEENING;
	}
	
	public static boolean hasMaskOfBrokenFingers(Entity target) {
		if (!(target instanceof Player))
			return true;
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == ItemIdentifiers.MASK_OF_BROKEN_FINGERS || hat == ItemIdentifiers.HELM_OF_THE_DEAD_HAND;
	}
	
	public static boolean hasMaskOfGranite(Entity target) {
		if (!(target instanceof Player))
			return true;
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == ItemIdentifiers.MASK_OF_GRANITE || hat == ItemIdentifiers.HELM_OF_GROTESQUERY;
	}

	public static boolean hasMaskOfReflection(Entity target) {
		if (!(target instanceof Player))
			return true;
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == ItemIdentifiers.MASK_OF_REFLECTION || hat == ItemIdentifiers.HELM_OF_LITTLE_KINGS;
	}
	...
	public static boolean hasMask(Entity target) {
		...
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat == 1506 || hat == 4164 || hat == 13277 || hasSlayerHelmet(target) || hasMaskOfMourning(target) || hasMaskOfBrokenFingers(target)
				|| hasMaskOfGranite(target);
	}
	...
	public static boolean hasBlackMask(Entity target) {
		if (!(target instanceof Player))
			return true;
		Player targetPlayer = (Player) target;
		int hat = targetPlayer.getEquipment().getHatId();
		return hat >= 8900 && hat <= 8922;
	}
	...
	public static boolean hasReflectiveEquipment(Entity target) {
		...
		return shieldId == 4156 || hasMaskOfReflection(target);
	}
	...
	public static boolean isUsingBell(final Player player) {
		...
		for (final WorldObject object : objects) {
			if (!object.withinDistance(player, 3) || object.getId() != 22545)
				continue;
			player.sm("The bell re-sounds loudly throughout the cavern.");
