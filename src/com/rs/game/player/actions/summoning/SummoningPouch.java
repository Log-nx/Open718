...
public enum SummoningPouch {
	...
	UNICORN_STALLION_POUCH(12039, 88, 154.4, 6822, 1.8, 9, new Item(12159),
			new Item(237), new Item(12155), new Item(12183, 140)),

	STEEL_TITAN_POUCH(12790, 99, 435.2, 7343, 4.9, 10, new Item(12160),
			new Item(1119), new Item(12155), new Item(12183, 178)),
	
	ASSASSIN_POUCH(15073, 99, 435.2, 8422, 4.9, 10, new Item(12160),
			new Item(1119), new Item(12155), new Item(12183, 178)),
	
	ASSASSIN_MELEE_POUCH(15075, 99, 435.2, 25608, 4.9, 10, new Item(12160),
			new Item(1119), new Item(12155), new Item(12183, 178));
