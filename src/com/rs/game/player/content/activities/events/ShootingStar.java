...
public class ShootingStar {
	...
	public static void mine(Player player, WorldObject object) {
		...
		if (!star.isFirstClick()) {
			star.setFirstClick();
			player.getStatistics().setFoundShootingStar();
			player.getStatistics().incrementStarsFound();
			...
			player.sm("You've found a Shooting Star; stars found: " + Colors.RED
					+ Utils.getFormattedNumber(player.getStatistics().getStarsFound())+"</col>.");
