...
public class DungeonConstants {
	...
	public static WorldTile DAMONHEIM_LOBBY = new WorldTile(3450, 3725, 0);
	...
	public static int[] randomFood = new int[]      { 18159, 18161, 18163, 18165, 18167, 18169, 18171, 18173, 18175, 18177};
