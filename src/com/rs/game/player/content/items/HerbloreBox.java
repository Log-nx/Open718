...
public class HerbloreBox {
	...
	public static void open(Player player) {
    	...
    	player.addItem((Utils.random(1000) < 800 ? COMMON[Utils.random(COMMON.length)] : (Utils.random(1000) >= 800 && Utils.random(1000) < 935 ? UNCOMMON[Utils.random(UNCOMMON.length)] : RARES[Utils.random(RARES.length)])));
    	player.addItem((Utils.random(1000) < 800 ? COMMON[Utils.random(COMMON.length)] : (Utils.random(1000) >= 800 && Utils.random(1000) < 935 ? UNCOMMON[Utils.random(UNCOMMON.length)] : RARES[Utils.random(RARES.length)])));
    	player.addItem((Utils.random(1000) < 800 ? COMMON[Utils.random(COMMON.length)] : (Utils.random(1000) >= 800 && Utils.random(1000) < 935 ? UNCOMMON[Utils.random(UNCOMMON.length)] : RARES[Utils.random(RARES.length)])));
    	player.addItem((Utils.random(1000) < 800 ? COMMON[Utils.random(COMMON.length)] : (Utils.random(1000) >= 800 && Utils.random(1000) < 935 ? UNCOMMON[Utils.random(UNCOMMON.length)] : RARES[Utils.random(RARES.length)])));
    	player.addItem((Utils.random(1000) < 800 ? COMMON[Utils.random(COMMON.length)] : (Utils.random(1000) >= 800 && Utils.random(1000) < 935 ? UNCOMMON[Utils.random(UNCOMMON.length)] : RARES[Utils.random(RARES.length)])));
