...
public class VirtualValues {
	...
	public static void setValues() {
		...
		//Sara brew n resotre pots (3)
		if (GrandExchange.getPrice(127) < 3500)
			GrandExchange.setPrice(127, Utils.random(3500, 7500));
		if (GrandExchange.getPrice(6687) < 10000)
			GrandExchange.setPrice(127, Utils.random(11000, 20000));
	}
}