...
public enum Pets {
	...
	CAT_1(1556, 1562, 1568, 762, 769, 775, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944, 349,
			331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),

	CAT_2(1557, 1563, 1569, 763, 770, 776, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944, 349,
			331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),

	CAT_3(1558, 1564, 1570, 764, 771, 777, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944, 349,
			331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),

	CAT_4(1559, 1565, 1571, 765, 772, 778, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944, 349,
			331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),

	CAT_5(1560, 1566, 1572, 766, 773, 779, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944, 349,
			331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),

	HELLCAT(7583, 7582, 7581, 3505, 3504, 3503, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944,
			349, 331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),

	CAT_7(14089, 14090, 15092, 8217, 8214, 8216, 0.0154320987654321, 0, 321, 363, 341, 15264, 345, 377, 353, 389, 7944,
			349, 331, 327, 395, 383, 317, 371, 335, 359, 15264, 15270, 1927),
	...
	DALMATIAN_1(12712, 12713, -1, 7249, 7250, -1, 0.0033333333333333, 4, 2132, 2134, 2136, 2138, 10816, 9986, 9978,
			526),

	DALMATIAN_2(12714, 12715, -1, 7251, 7252, -1, 0.0033333333333333, 4, 2132, 2134, 2136, 2138, 10816, 9986, 9978,
			526),
	...
	GREYHOUND_1(12704, 12705, -1, 7241, 7242, -1, 0.0033333333333333, 4, 2132, 2134, 2136, 2138, 10816, 9986, 9978,
			526),

	GREYHOUND_2(12706, 12707, -1, 7243, 7244, -1, 0.0033333333333333, 4, 2132, 2134, 2136, 2138, 10816, 9986, 9978,
			526),
	...
	ROWENA(32513, -1, -1, 20227, -1, -1, 0.0, 99),

	EDDY(32730, -1, -1, 20292, -1, -1, 0.0, 99),

	PENNY(32613, -1, -1, 20268, -1, -1, 0.0, 99),
	
	MINISTER(40669, -1, -1, 24772, -1, -1, 0.0, 99),
	
	PERDITA(42778, -1, -1, 25533, -1, -1, 0.0, 99),
	
	CLOVER(41104, -1, -1, 24837, -1, -1, 0.0, 99),
	
	VINNY(41112, -1, -1, 24850, -1, -1, 0.0, 99),
	
	BLUE(41999, -1, -1, 25165, -1, -1, 0.0, 99),
	
	KING_OF_SPADES(55, -1, -1, 25188, -1, -1, 0.0, 99),
	...
	REPENTANT_HORROR(ItemIdentifiers.REPENTANT_HORROR, -1, -1, 19710, -1, -1, 0.0, 99),

	REPENTANT_BEAST(ItemIdentifiers.REPENTANT_BEAST, -1, -1, 19712, -1, -1, 0.0, 99),

	REPENTANT_OGRE(ItemIdentifiers.REPENTANT_OGRE, -1, -1, 19714, -1, -1, 0.0, 99),

	PIGGLES(ItemIdentifiers.PIGGLES, -1, -1, 18625, -1, -1, 0.0, 99),

	COMMANDER_PORKINS(ItemIdentifiers.COMMANDER_PORKINS, -1, -1, 18627, -1, -1, 0.0, 99),
	...
	EFFY(ItemIdentifiers.EFFY, -1, -1, 25456, -1, -1, 0.0, 99),
	
	KURORYU(ItemIdentifiers.KURORYU, -1, -1, 25617, -1, -1, 0.0, 99),
	...
	/*
	 * Tatsuya's Slayer Pet's
	 */

	AIRUT(30230, -1, -1, 21835, -1, -1, 0.0, 99),

	ABYSSAL_DEMON(4149, -1, -1, 9086, -1, -1, 0.0, 99),

	NIGHTMARE(39259, -1, -1, 23698, -1, -1, 0.0, 99),

	PYREFIEND(4138, -1, -1, 17023, -1, -1, 0.0, 99),

	CRAWLING_HAND(4133, -1, -1, 14202, -1, -1, 0.0, 99),
	...
	GOLDEN_CHINCHOMPA(ItemIdentifiers.ADULT_GOLDEN_CHINCHOMPA, -1, -1, 18209, -1, -1, 0.0, 1),
	...
	SQIRKS_THE_PARROT(ItemIdentifiers.SQIRKS_THE_PARROT, -1, -1, 17087, -1, -1, 0.0, 1),
	
	BLIGHTBOUND_LASHER(42778, -1, -1, 25531, -1, -1, 0.0, 1),

	// Skilling Pets
	
	SIFU(ItemIdentifiers.SIFU, -1, -1, 25017, -1, -1, 0.0, 1),
	
	KANGALI(ItemIdentifiers.KANGALI, -1, -1, 25019, -1, -1, 0.0, 1),
	
	WALLACE(ItemIdentifiers.WALLACE, -1, -1, 25021, -1, -1, 0.0, 1),
	
	MORTY(ItemIdentifiers.MORTY, -1, -1, 25023, -1, -1, 0.0, 1),
	
	SPARKY(ItemIdentifiers.SPARKY, -1, -1, 25025, -1, -1, 0.0, 1),
	
	GHOSTLY(ItemIdentifiers.GHOSTLY, -1, -1, 25027, -1, -1, 0.0, 1),
	
	NEWTON(ItemIdentifiers.NEWTON, -1, -1, 25029, -1, -1, 0.0, 1),
	
	SHAMINI(ItemIdentifiers.SHAMINI, -1, -1, 25031, -1, -1, 0.0, 1),

	DOJO_MOJO(ItemIdentifiers.DOJO_MOJO, -1, -1, 23176, -1, -1, 0.0, 1),

	BABY_YAGA(ItemIdentifiers.BABY_YAGAS_HOUSE, -1, -1, 23178, -1, -1, 0.0, 1),

	RAMSAY(ItemIdentifiers.RAMSAY, -1, -1, 23180, -1, -1, 0.0, 1),

	GEMI(ItemIdentifiers.GEMI, -1, -1, 23182, -1, -1, 0.0, 1),

	WILLOW(ItemIdentifiers.WILLOW, -1, -1, 23184, -1, -1, 0.0, 1),

	GORDIE(ItemIdentifiers.GORDIE, -1, -1, 23186, -1, -1, 0.0, 1),

	BRAINS(ItemIdentifiers.BRAINS, -1, -1, 23188, -1, -1, 0.0, 1),

	BERNIE(ItemIdentifiers.BERNIE, -1, -1, 23190, -1, -1, 0.0, 1),

	BUBBLES(ItemIdentifiers.BUBBLES, -1, -1, 23192, -1, -1, 0.0, 1),

	FLO(ItemIdentifiers.FLO, -1, -1, 23194, -1, -1, 0.0, 1),

	HEBRERT(ItemIdentifiers.HERBERT, -1, -1, 23196, -1, -1, 0.0, 1),

	ACE(ItemIdentifiers.ACE, -1, -1, 23198, -1, -1, 0.0, 1),

	MALCOLM(ItemIdentifiers.MALCOLM, -1, -1, 23200, -1, -1, 0.0, 1),

	ROCKY(ItemIdentifiers.ROCKY, -1, -1, 23202, -1, -1, 0.0, 1),

	RUE(ItemIdentifiers.RUE, -1, -1, 23204, -1, -1, 0.0, 1),

	CRABBE(ItemIdentifiers.CRABBE, -1, -1, 23206, -1, -1, 0.0, 1),

	SMITHY(ItemIdentifiers.SMITHY, -1, -1, 23208, -1, -1, 0.0, 1),

	RALPH(ItemIdentifiers.RALPH_PET, -1, -1, 23210, -1, -1, 0.0, 1),

	WOODY(ItemIdentifiers.WOODY_PET, -1, -1, 23212, -1, -1, 0.0, 1),

	LION_CUB(ItemIdentifiers.LION_CUB, -1, -1, 21425, -1, -1, 0.0, 1),

	CORGI(ItemIdentifiers.CORGI, -1, -1, 15511, -1, -1, 0.0, 1),

	TESS(37680, -1, -1, 22925, -1, -1, 0.0, 1),;
