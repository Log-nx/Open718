package com.rs.game.player.content.prifiddinas;
...
import com.rs.game.player.actions.agility.PrifddinasAgilityCourse;
...
import com.rs.game.player.actions.prayer.SerenStoneCleansing;
...
import com.rs.game.player.content.activities.MotherlodeMaw;
...
public class PrifddinasCity {
		...
		switch (object.getId()) {
			...
			case 92694: /** Holiday Portal **/ 
				...
				player.getDialogueManager().startDialogue("SimpleMessage", 
						"The Portal is currently inactive; no events "
			...
			case 94101:
			case 92708:
				player.getPackets().sendGameMessage("You search the crates, but find nothing of interest..");
				break;
			...
			case 94197:
				player.getDialogueManager().startDialogue("SimpleMessage", "Crystals can not yet be retrieved; "
						+ "stay tuned!");
				break;
			case 94179: /** Loom **/
				player.getDialogueManager().startDialogue("SimpleMessage", 
			...
			case 94077:
				if (player.getTask() != null) {
					if (player.getSlayerManager().getCurrentTask().getName().toLowerCase().contains("edimmu")) {
			...
			case 94319: // 95 Dungeoneering on the north side containing a bloodwood tree, 
						// pawyas and grenwalls, implings, and random divine locations.
				player.getDialogueManager().startDialogue("SimpleMessage", "This resource dungeon is currently "
						+ "not supported; stay tuned!");
				break;
			case 94047: /** Hefin Cithadel Altar **/
			...
			case 94048:
				...
				break;
			case 93115:
				//TODO Serenity posts - http://runescape.wikia.com/wiki/Serenity_posts
			...
			case 92240:
			case 92256:
				player.getDialogueManager().startDialogue("SimpleMessage", "Teleport attuning is not yet added; " + "stay tuned! - We do not have the right object config ID's for attuned versions.");
				break;
			case 92358:
			case 92349:
			case 92298:
	...
	public static boolean handleObjectOption2(Player player, WorldObject object) {
		switch (object.getId()) {
			...
			case 92413: /** Clan Portal **/ 
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2972, 3289, 0));
				player.getPackets().sendGameMessage("Clan Citadels are not yet supported; stay tuned!");
				break;
			case 2564: /** Elven Grimoire **/
				player.getDialogueManager().startDialogue("AltarSwapD");
				break;
			...
			case 94230: /** Summoning Obelisk **/
				...
				if (player.getSkills().getLevel(Skills.SUMMONING) < summonLevel) {
					...
					player.getPackets().sendGameMessage("You've recharged your Summoning points.", true);
				} else {
	...
	public static boolean handleItemOnObject(Player player, WorldObject object, Item item) {
		switch (object.getId()) {
			...
			case 94066: /** Sand Pit **/
				...
				player.getPackets().sendGameMessage("You can not fill this item with sand.");
				break;
			default:
				return false;
		}
		...
		switch (npc.getId()) {
			...
			case 20311:
				player.getDialogueManager().startDialogue("SimpleNPCMessage", 
						npc.getId(), "Don't worry, I'll look after your plants.");
				break;
			case 20294:
			case 20295:
			...
			case 19828:
				Dialogue dialogue = new Dialogue() {
					...
					@Override
					public void start() {
					    sendNPCDialogue(npc.getId(), CALM, "Hello there. "
					    		+ "Can I tempt you with a slightly magical stick? "
	...
	public static boolean handleNPCOption4(Player player, NPC npc) {
		switch (npc.getId()) {
			case 19921:
				player.getDialogueManager().startDialogue("SimpleNPCMessage", 
						npc.getId(), "There's nothing to redeem currently.");
				break;
			case 20112:
