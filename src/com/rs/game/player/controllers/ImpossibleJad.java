...
import com.rs.game.npc.impossiblejad.AgrithNaNa;
import com.rs.game.npc.impossiblejad.Culinaromancer;
import com.rs.game.npc.impossiblejad.Dessourt;
import com.rs.game.npc.impossiblejad.Flambeed;
import com.rs.game.npc.impossiblejad.ImpossibleJadNPC;
import com.rs.game.npc.impossiblejad.Karamel;
...
public class ImpossibleJad extends Controller {
	...
	public void exitCave() {
		...
		player.setNextWorldTile(new WorldTile(1866, 5323, 0));
	...
	public void loadCave() {
		...
		RegionBuilder.copyAllPlanesMap(237, 669, boundChuncks[0],
				boundChuncks[1], 8);
