...
import com.rs.game.npc.instances.InstanceBlink;
...
public class BlinkInstance extends Controller {
	...
	public static void enterTrioInstance(Player player) {
		player.getControllerManager().startController("BlinkInstanceControler", 1);
	}

	@Override
	public void start() {
		boundChuncks = RegionBuilder.findEmptyChunkBound(8, 8);
		RegionBuilder.copyAllPlanesMap(209, 538, boundChuncks[0], boundChuncks[1], 8);	
	...
	public void startWave() {
		try {
		new InstanceBlink(12878, getSpawnTile(0));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
