...
import com.rs.game.npc.instances.InstanceGiantMole;
import com.rs.game.npc.instances.godwars.bandos.InstanceBandos;
import com.rs.game.npc.instances.godwars.bandos.InstanceGrimspike;
import com.rs.game.npc.instances.godwars.bandos.InstanceSteelwill;
import com.rs.game.npc.instances.godwars.bandos.InstanceStrongstack;
...
public class GiantMoleInstance extends Controller {
	...
	private int count;
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(2984, 3381, 0);

	@Override
	public void start() {
		boundChuncks = RegionBuilder.findEmptyChunkBound(12, 12);
		RegionBuilder.copyAllPlanesMap(22, 59, boundChuncks[0], boundChuncks[1], 8);	
	...
	public void startWave() {
		try {
		new InstanceGiantMole(3340, getSpawnTile(0));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
