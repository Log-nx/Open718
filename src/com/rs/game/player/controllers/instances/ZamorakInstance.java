...
import com.rs.game.npc.instances.godwars.zamorak.InstanceGritch;
import com.rs.game.npc.instances.godwars.zamorak.InstanceKarlack;
import com.rs.game.npc.instances.godwars.zamorak.InstanceKreeyath;
import com.rs.game.npc.instances.godwars.zamorak.InstanceZamorak;
...
public class ZamorakInstance extends Controller {
	...
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(2925, 5334, 0);

	public static void enterTrioInstance(Player player) {
		player.getControllerManager().startController("ZamorakInstanceControler", 1);
	}

	@Override
	public void start() {
		boundChuncks = RegionBuilder.findEmptyChunkBound(8, 8);
		RegionBuilder.copyAllPlanesMap(364, 664, boundChuncks[0], boundChuncks[1], 8);	
	...
	public void startWave() {
		try {
		new InstanceZamorak(6203, getSpawnTile(2));
		new InstanceKarlack(6204, getSpawnTile(2));
		new InstanceGritch(6206, getSpawnTile(2));
		new InstanceKreeyath(6208, getSpawnTile(2));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
	...
	public WorldTile getSpawnTile(int num) {
		switch (num) {
		case 0:
			return getWorldTile(19, 24);
		case 1:
			return getWorldTile(19, 24);
		case 2:
			return getWorldTile(19, 13);
		default:
