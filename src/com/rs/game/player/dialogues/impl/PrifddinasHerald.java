...
public class PrifddinasHerald extends Dialogue {
	...
	public void run(int interfaceId, int componentId)  {
		...
		case 5:
			...
			switch (componentId) {
			case OPTION_1:
				if (player.getMoneyPouch().getCoinsAmount() >= (100000) && getClanCape(herald) != -1) {
		...
		case 9:
			...
			switch (componentId) {
			case OPTION_1:
				if (player.getMoneyPouch().getCoinsAmount() >= (1000000)) {
					player.getMoneyPouch().sendDynamicInteraction(1000000, true);
