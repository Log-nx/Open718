	...
	public void run(int interfaceId, int componentId)  {
		...
		case 3:
			...
			case OPTION_1:
				...
				sendNPCDialogue(
						17065,
						HAPPY,
						"Warbands are a wilderness activity that occur hourly, here within Nexus. The objective of the minigame is to siphon the obelisk in the center of the camp undetected, then once having done so, loot the resources from within the camp.");
				break;
			case OPTION_2:
				stage = 2;
				sendNPCDialogue(
			...
			case OPTION_4:
				stage = -1;
				sendNPCDialogue(17065, NORMAL, "Maintain the balance, "
		...
		case 6:
			...
			sendNPCDialogue(
					17065,
					NONONO_FACE,
					"In keeping with the teachings of Guthix, I cannot intervene directly. Rather, I seek to influence deathEventController by introduction of a balancing force.");
			break;
		case 7:
			stage = 2;
			sendNPCDialogue(
		...
		case 15:
			stage = 12;
			sendOptionsDialogue("Reward Selection", "Turn into gold.",
			...
			if (amount > 0) {
				...
				sendNPCDialogue(
						...
						componentId == OPTION_1 ? "Your supplies have been converted into "
								+ Utils.formatNumber(8000 * amount) + " gold."
								: "Your supplies have been converted into xp.");
			} else {
				stage = -1;
				sendNPCDialogue(17065, SAD,
