...
import com.rs.game.player.actions.construction.House.ObjectReference;
...
public class PortalChamberD extends Dialogue {
	...
	private static final int[][] RUNES =
		...
		public void start() {
			...
			sendDialogue("To direct a portal you need enough runes for 100 castings of that teleport spell."
		...
		public void run(int interfaceId, int componentId)  {
			if (stage == -1) {
				...
				sendOptionsDialogue("Redirect which portal?", existingPortals[0] ? OPTION_NAMES[primaryFrame] : "No portal frame", existingPortals[1] ? OPTION_NAMES[secondaryFrame] : "No portal frame", existingPortals[2] ? OPTION_NAMES[tertiaryFrame] : "No portal frame");
				stage = 0;
			} else if (stage == 0) {
