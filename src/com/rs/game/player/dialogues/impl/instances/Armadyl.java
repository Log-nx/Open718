...
public class Armadyl extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaArmadyl(bool);
	}
	private String getString = "ArmadylInstance";
	public void startController() {
		player.getControllerManager().startController("ArmadylInstance");	
	}
	public Armadyl() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Armadyl";
		player.setOutside(new WorldTile(2835, 5293, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaArmadyl();
		if (stage == 1) {	
