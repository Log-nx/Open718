...
public class Bandos extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaBandos(bool);
	}
	private String getString = "BandosInstance";
	public void startController() {
		player.getControllerManager().startController("BandosInstance");	
	}
	public Bandos() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Bandos";
		player.setOutside(new WorldTile(2861, 5357, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaBandos();
		if (stage == 1) {	
