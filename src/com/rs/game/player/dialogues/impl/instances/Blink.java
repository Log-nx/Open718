...
public class Blink extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaBlink(bool);
	}
	private String getString = "BlinkInstance";
	public void startController() {
		player.getControllerManager().startController("BlinkInstance");	
	}
	public Blink() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Blink";
		player.setOutside(new WorldTile(1686, 4326, 0));
		stage = 1;
