...
public class DagannothKings extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaDagKing(bool);
	}
	private String getString = "DagannothKingInstance";
	public void startController() {
		player.getControllerManager().startController("DagannothKingInstance");	
	}
	...
	public void start() {
		stage = 100;
		player.instanceDialogue = "DagannothKing";
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaDagKing();
		if (stage == 1) {	
