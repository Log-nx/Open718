...
public class GiantMole extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaGeno(bool);
	}
	private String getString = "GiantMoleInstance";
	public void startController() {
		player.getControllerManager().startController("GiantMoleInstance");	
	}
	public GiantMole() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "GiantMole";
		player.setOutside(new WorldTile(1750, 5243, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaGeno();
		if (stage == 1) {	
			if (componentId == OPTION_1) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(1750, 5243, 0));
