...
public class KalphiteKing extends Dialogue {
	...
	private String getString = "KalphiteKingInstance";
	
	public void startController() {
		player.getControllerManager().startController("KalphiteKingInstance");	
	}
	...
	public void start() {
		stage = 100;
		player.instanceDialogue = "KalphiteKing";
