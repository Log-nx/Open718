...
public class KalphiteQueen extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaKQ(bool);
	}
	private String getString = "KalphiteQueenInstance";
	public void startController() {
		player.getControllerManager().startController("KalphiteQueenInstance");	
	}
	...
	public void start() {
		stage = 100;
		player.instanceDialogue = "KalphiteQueen";
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaKQ();
		if (stage == 1) {	
