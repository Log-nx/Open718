...
public class KingBlackDragon extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaKBD(bool);
	}
	private String getString = "KingBlackDragonInstance";
	public void startController() {
		player.getControllerManager().startController("KingBlackDragonInstance");	
	}
	...
	public void start() {
		stage = 100;
		player.instanceDialogue = "KingBlackDragon";
		player.setOutside(new WorldTile(3069, 10250, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaKBD();
		if (stage == 1) {	
