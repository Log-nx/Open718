...
public class Nex extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaNex(bool);
	}
	private String getString = "NexInstance";
	public void startController() {
		player.getControllerManager().startController("NexInstance");	
	}
	public Nex() {
	}
	...
	public void start() {
		stage = 100;
		player.instanceDialogue = "Nex";
		player.setOutside(new WorldTile(2904, 5203, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaNex();
		if (stage == 1) {	
