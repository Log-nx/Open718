...
public class Sunfreet extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaBlink(bool);
	}
	
	private String getString = "SunfreetInstance";
	
	public void startController() {
		player.getControllerManager().startController("SunfreetInstance");	
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Sunfreet";
		player.setOutside(new WorldTile(3376, 3930, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaBlink();
		if (stage == 1) {	
