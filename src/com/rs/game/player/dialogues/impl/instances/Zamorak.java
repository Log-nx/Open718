...
public class Zamorak extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaZamorak(bool);
	}
	private String getString = "ZamorakInstance";
	public void startController() {
		player.getControllerManager().startController("ZamorakInstance");	
	}
	public Zamorak() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Zamorak";
		player.setOutside(new WorldTile(2925, 5334, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId)  {
		boolean getPerma = player.getPermaZamorak();
		if (stage == 1) {	
