...
public class SlayerRewards extends Dialogue {
	...
	public void start() {
		...
		if (name.equalsIgnoreCase("gpcollector")) {
			sendOptionsDialogue("Do you wish to unlock the Coin Collector perk?", "Yes", "No");
			stage = 8;
			return;
		}
		...
		if (name.equalsIgnoreCase("charmingimp")) {
			sendOptionsDialogue("Do you wish to unlock the Charming Imp perk?", "Yes", "No");
			stage = 21;
			return;
		}
	...
	public void run(int interfaceId, int componentId) {
		...
		case 1:
			if (componentId == OPTION_1) {
				if (canBuyItem()) {
					...
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought a Slayer helmet for 400 slayer points!");
		...
		case 2:
			if (componentId == OPTION_1) {
				if (canBuyXP()) {
					...
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought 10'000 Slayer experience for 40 slayer points!");
		...
		case 3:
			if (componentId == OPTION_1) {
				if (canBuyItem()) {
					...
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought a Ring of Slaying for 75 slayer points!");
					SlayerTask.openSlayerShop(player);
				}
				return;
			}
		...
		case 4:
			if (componentId == OPTION_1) {
				if (canBuyItems(560, 558)) {
					...
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought runes for 250 Slayer dart casts for 35 slayer points!");
					SlayerTask.openSlayerShop(player);
				}
				return;
			}
		...
		case 5:
			if (componentId == OPTION_1) {
				if (canBuyItem()) {
					...
					player.setSlayerPoints(player.getSlayerPoints() - 35);
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought 250 broad-tipped bolts for 35 slayer points!");
					SlayerTask.openSlayerShop(player);
				}
				return;
			}
		...
		case 6:
			if (componentId == OPTION_1) {
				if (canBuyItem()) {
					...
					player.setSlayerPoints(player.getSlayerPoints() - 35);
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought 250 broad-tipped arrows for 35 slayer points!");
					SlayerTask.openSlayerShop(player);
				}
				return;
			}
		...
		case 8:
			if (componentId == OPTION_1) {
				if (canBuyPerk()) {
					player.getPerkManager().unlockPerk(PlayerPerks.COIN_COLLECTOR);
					player.setSlayerPoints(player.getSlayerPoints() - 500);
					player.getDialogueManager().startDialogue("SimpleMessage", "You have unlocked the Coin Collector perk for 500 slayer points! It works automatically and is not needed to configure.");
					SlayerTask.sendLearn(player);
				}
				return;
			}
			...
			break;
		case 15:
			sendOptionsDialogue("Which ring do you want to imbue?", "Archers' ring", "Seers' ring", "Warrior ring", "Berserker ring");
			stage = 16;
			break;
		case 16:
			if (componentId == OPTION_1) {
				if (canImbueRing(6733)) {
					...
					player.getDialogueManager().startDialogue("SimpleMessage", "Your ring has been successfully imbued!");
					SlayerTask.sendLearn(player);
					return;
				}
			}
		...
		case 20:
			if (componentId == OPTION_1) {
				if (canBuyItem()) {
					...
					player.getDialogueManager().startDialogue("SimpleMessage", "You have bought an Attuned crystal weapon seed for 200 slayer points!");
					SlayerTask.sendLearn(player);
				}
				return;
			}
		...
		case 21:
			if (componentId == OPTION_1) {
				if (canBuyPerk()) {
					player.getPerkManager().unlockPerk(PlayerPerks.CHARM_COLLECTOR);
					player.setSlayerPoints(player.getSlayerPoints() - 500);
					player.getDialogueManager().startDialogue("SimpleMessage", "You have unlocked the Charm Collector perk for 500 slayer points! It works automatically and is not needed to configure.");
					SlayerTask.sendLearn(player);
				}
				return;
			}
	...
	private boolean canImbueRing(int ringId) {
		if (player.getSlayerPoints() >= points) {
			...
			player.getDialogueManager().startDialogue("SimpleMessage", "You must have the ring in your inventory to imbue it.");
			return false;
		}
	...
	private boolean canBuyItem() {
		if (player.getSlayerPoints() >= points) {
			if (player.getInventory().hasFreeSlots())
				return true;
			player.getDialogueManager().startDialogue("SimpleMessage", "You do not have enough free inventory space to buy this.");
			return false;
		}
		player.getDialogueManager().startDialogue("SimpleMessage", "You do not have enough slayer points to buy this.");
		return false;
	...
	private boolean canCancelTask() {
		...
		player.getDialogueManager().startDialogue("SimpleMessage", "You do not have enough slayer points to skip your current Slayer task.");
		return false;
	}
