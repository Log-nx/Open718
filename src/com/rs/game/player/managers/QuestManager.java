...
import com.rs.game.player.content.tutorial.Reward;
...
public final class QuestManager implements Serializable {
	...
	public void completeQuest(Quests quest) {
		...
		sendCompletedQuestsData(quest); 
		Reward.sendRewardInterface(player, quest);
	...
	public void sendCompletedQuestsData(Quests quest) {
		switch(quest) {
			case PERIL_OF_ICE_MONTAINS:
				player.getPackets().sendConfigByFile(4684, 150);
			break;
		}
	}
	...
	public void sendProgressAssistant(Quests quest) {
		switch(quest) {
