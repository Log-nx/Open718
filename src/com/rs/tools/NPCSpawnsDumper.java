...
public class NPCSpawnsDumper {
	...
	public static final void main(String[] args) throws IOException {
		...
		Logger.log("GameServer", "Initing Cache...");
		Cache.init();
		Logger.log("GameServer", "Initing Data File...");
		MapArchiveKeys.init();
	...
	public static final void dumpRegionNPCs(int regionId, BufferedWriter writer)
		...
		int npcSpawnsContainerId = Cache.RS3CACHE.getIndexes()[5].getArchiveId("n"
				+ ((regionX >> 3) / 8) + "_" + ((regionY >> 3) / 8));
		if (npcSpawnsContainerId == -1)
			return;
		byte[] npcSpawnsContainerData = Cache.RS3CACHE.getIndexes()[5].getFile(
