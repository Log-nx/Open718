...
public final class NPCSpawns {
	...
	public static void loadCustomSpawnList() {
		new NPC(6524, new WorldTile(2879, 3421, 0), 0, false);
		new NPC(3404, new WorldTile(2879, 3422, 0), 0, false);
		// Quercus
		new NPC(17065, new WorldTile(3135, 3521, 0), -1, false);
		new NPC(22889, new WorldTile(3819, 7048, 0), 0, false);
		new NPC(19332, new WorldTile(3872, 6823, 0), -1, true);
		
		//NPCs
		new NPC(23419, new WorldTile(3159, 3476, 0), -1, false);
		new NPC(587, new WorldTile(3160, 3476, 0), -1, false);
		new NPC(6881, new WorldTile(3161, 3476, 0), -1, false);
		new NPC(93, new WorldTile(2990, 3942, 0), -1, true);
