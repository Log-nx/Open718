...
public final class Huffman {
	...
	public static final void init() {
		byte[] huffmanFile = Cache.RS3CACHE.getIndexes()[10].getFile(Cache.RS3CACHE
	...
	public static final String readEncryptedMessage(int maxLength,
			InputStream stream) {
		try {
			...
			String message = Utils.getUnformatedMessage(messageDataLength, 0,
					messageData);
			return message;
		} catch (Throwable e) {
			return "";
